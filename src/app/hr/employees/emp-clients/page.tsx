...
export default function UsersClient({
  ...
  const safeEmployees: UserRow[] = Array.isArray(employees) ? employees : [];
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [search, safeEmployees, sortBy, sortDir]);
        ...
        <SidebarInset>
          ...
          <div className="flex flex-col gap-6 p-6 pt-4 bg-muted/10">
            ...
            <p className="text-sm text-muted-foreground">
              Showing {filtered.length} of {safeEmployees.length} employees
            </p>
          </div>
        </SidebarInset>
      </SidebarProvider>
