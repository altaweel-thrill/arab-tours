            ...
            <div className="min-h-screen bg-background p-6 space-y-8">
                ...
                <div className="flex gap-2">
                  ...
                  {canManagePrivileges && (
                    <Button asChild variant="outline">
                      <Link href={`/hr/employees/${id}/privileges`}>
                        Manage Privileges
                      </Link>
                    </Button>
                  )}
              ...
              <Card>
                ...
                <CardContent>
                  <Calendar
                    mode="single"
                    month={new Date(2025, 9)}
                    modifiers={{ present: presentDays, absent: absentDays }}
                    modifiersClassNames={{
                      present:
                        "bg-green-100 text-green-800 font-semibold rounded-full",
                      absent:
                        "bg-red-100 text-red-800 font-semibold rounded-full",
                    }}
                  />
